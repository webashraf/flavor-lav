...
<footer className="footer p-10 bg-base-200 text-base-content">
  <div>
    ...
    <a className="link link-hover">World Class Food</a> 
    <a className="link link-hover">Best Flavor</a> 
    <a className="link link-hover">100% pure</a>
  </div> 
  <div>
  ...
  <div>
    ...
    <div className="form-control w-80">
      ...
      <div className="relative">
        ...
        <button className="btn bg-lime-500 border-lime-500 absolute top-0 right-0 rounded-l-none">Subscribe</button>
      </div>
    </div>
  </div>
</footer>
